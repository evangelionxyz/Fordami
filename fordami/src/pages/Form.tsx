...
import { QueueProps } from "../components/QueueContext";
import {
  doc,
  addDoc,
  updateDoc,
...
import { formatDateTime, getTimestamp } from "../utils";
...
const Form = () => {
  ...
  const handleReturnTimeInputChange = (
    ...
    const resetDate = new Date(year, month - 1, day, hours, minutes, 0, 0);
  ...
  const handleConfirmBt = async (
    ...
    try {
      ...
      setReturnDateTime("");
      setResetTime(null);
      showAlertMessage("Kendaraan berhasil dipinjam", "success");
    } catch (error) {
                ...
                <div className="row">
                  ...
                  <div>
                    ...
                    <div className="row mb-2">
                      ...
                      <div className="col">
                        <div className="row">
                          {vehicles[selectedVehicle]?.invItems.map(
                            (item, index) => (
                              <label>{item}</label>
                            )
                          )}
